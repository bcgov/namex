...
async def subscribe_to_queue(stan_client: stan.aio.client.Client,
    ...
    """
    entity_subject = os.getenv('NATS_TEST_SUBJECT', 'test_subject')
    entity_queue = os.getenv('STAN_QUEUE', 'test-queue')
    entity_durable_name = os.getenv('LEGAL_FILING_STAN_DURABLE_NAME', 'test-durable-queue')
