"""Configuration module for Bad Designation Notifier project."""
...
class DevConfig(Config):
    """Handles config for Dev."""

    DEBUG = True


class TestConfig(Config):
    """Handles config for test."""
