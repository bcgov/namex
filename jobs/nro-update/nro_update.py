...
with tracer.start_active_span('job_start') as scope:
    try:
        ...
        with tracer.start_active_span('pickup_nrs', child_of=scope.span) as scope_pickup:
            ...
            scope_pickup.span.set_tag(tags.DATABASE_TYPE, 'postgresql')
            scope_pickup.span.set_tag(tags.DATABASE_STATEMENT,
            ...
            for r in q.all():
                ...
                with tracer.start_active_span('processing_nr', child_of=scope_pickup.span) as scope_process:
                    current_app.logger.debug('processing: {}'.format(r.nrNum))
                    scope_process.span.set_tag('nr.number', '{}'.format(r.nrNum))
                    ...
                    try:
                        ...
                        scope_process.span.set_tag(tags.ERROR, 'true')
                        tb = traceback.format_exc()
                        scope_process.span.log_kv({'event': 'error',
