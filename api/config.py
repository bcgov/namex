...
permits-licences/businesses-incorporated-companies/approval-business-name',
    ...
    SOLR_API_SERVICE_ACCOUNT_CLIENT_ID = os.getenv('NAME_REQUEST_SERVICE_ACCOUNT_CLIENT_ID', '')
    SOLR_API_SERVICE_ACCOUNT_CLIENT_SECRET = os.getenv('NAME_REQUEST_SERVICE_ACCOUNT_CLIENT_SECRET', '')
