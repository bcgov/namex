...
request_type_mapping = [
    ...
    ('XCR', EntityTypes.XPRO_CORPORATION.value, RequestAction.NEW_AML.value),
    ...
    ('XCP', EntityTypes.XPRO_COOPERATIVE.value, RequestAction.NEW_AML.value),
    ...
    ('XUL', EntityTypes.XPRO_UNLIMITED_LIABILITY_COMPANY.value, RequestAction.NEW_AML.value),
