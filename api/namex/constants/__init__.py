...
request_type_mapping = [
    ...
    ('ACR', EntityTypes.CORPORATION.value, RequestAction.AML.value),
    ...
    ('XACR', EntityTypes.XPRO_CORPORATION.value, RequestAction.AML.value),
    ...
    ('ACP', EntityTypes.COOPERATIVE.value, RequestAction.AML.value),
    ...
    ('ACC', EntityTypes.COMMUNITY_CONTRIBUTION_COMPANY.value, RequestAction.AML.value),
