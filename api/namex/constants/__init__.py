...
request_type_mapping = [
    ...
    ('SP', EntityTypes.SOLE_PROPRIETORSHIP.value, RequestAction.NEW.value),
    ('SP', EntityTypes.DOING_BUSINESS_AS.value, RequestAction.NEW.value),
    ('GP', EntityTypes.GENERAL_PARTNERSHIP.value, RequestAction.NEW.value),
    ('GP', EntityTypes.GENERAL_PARTNERSHIP.value, RequestAction.RESUBMIT.value),
    ('CSP', EntityTypes.SOLE_PROPRIETORSHIP.value, RequestAction.CHG.value, True),
    ('CGP', EntityTypes.GENERAL_PARTNERSHIP.value, RequestAction.CHG.value),
    ('CSP', EntityTypes.DOING_BUSINESS_AS.value, RequestAction.CHG.value),
    ('CSP', EntityTypes.DOING_BUSINESS_AS.value, RequestAction.RESUBMIT.value),
