...
request_type_mapping = [
    ...
    ('CT', EntityTypes.CONTINUE_IN.value, RequestAction.REH.value),
    ...
    ('CCCT', EntityTypes.CONTINUE_IN_CCC.value, RequestAction.REH.value),
    ...
    ('ULCT', EntityTypes.CONTINUE_IN_CUL.value, RequestAction.REH.value),
    ...
    ('BECT', EntityTypes.CONTINUE_IN_CBEN.value, RequestAction.REH.value),
