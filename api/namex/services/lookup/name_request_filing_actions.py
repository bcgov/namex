...
class NameRequestFilingActions:
    ...
    raw_nr_to_action_mapping = [
        ...
        ('XLL', 'XCR', 'Extraprovincial Limited Liability Partnership', 'Registration', 'static', None, 'https://www2.gov.bc.ca/gov/content/governments/organizational-structure/ministries-organizations/ministries/citizens-services/bc-registries-online-services', None),
        ('XCLL', 'XCR', 'Extraprovincial Limited Liability Partnership', 'Change of Name', 'static', None, 'https://www2.gov.bc.ca/gov/content/governments/organizational-structure/ministries-organizations/ministries/citizens-services/bc-registries-online-services', None),
        ...
        ('CCCT', 'CC', 'Community Contribution Co.', 'Continuation In', 'colin', None, None, None),
