...
def configure_logging(app):
    ...
    structlog.configure(processors=[structlog.contextvars.merge_contextvars] + structlog.get_config()['processors'])
    ...
    def bind_app_name():
        ...
        structlog.contextvars.bind_contextvars(
            app_name=request.headers.get('App-Name', 'unknown'), method=request.method, endpoint=request.path
        )
