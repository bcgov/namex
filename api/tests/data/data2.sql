...
insert into names
(id,name,state,choice,consumption_date,remote_name_id,nr_id)
values( nextval('names_id_seq'), 'my better company', 'NE', 2, null, null, (select id from requests where nr_num='NR00000022'))
;
insert into names
(id,name,state,choice,consumption_date,remote_name_id,nr_id)
values( nextval('names_id_seq'), 'my best company', 'NE', 3, null, null, (select id from requests where nr_num='NR00000022'))
;
