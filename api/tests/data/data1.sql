...
values
(nextval('requests_id_seq'), '2018-04-02 20:09:03.626463', 'DRAFT', 'NR 0000021', null, null, 'CR', 'Y', null, null,
'fire hydrants manufacture', 1, 'N',null, null, null, current_timestamp, null)
;

insert into names
(id,name,state,choice,consumption_date, corp_num, remote_name_id,nr_id)
values( nextval('names_id_seq'), 'my good company', 'NE', 1, null, null, null, (select id from requests where nr_num='NR 0000021'))
;
insert into names
(id,name,state,choice,consumption_date, corp_num, remote_name_id,nr_id)
values( nextval('names_id_seq'), 'my better company', 'NE', 2, null, null, null, (select id from requests where nr_num='NR 0000021'))
;
insert into names
(id,name,state,choice,consumption_date, corp_num, remote_name_id,nr_id)
values( nextval('names_id_seq'), 'my best company', 'NE', 3, null, null, null, (select id from requests where nr_num='NR 0000021'))
;
...
(select id from requests where nr_num='NR 0000021'))
;
