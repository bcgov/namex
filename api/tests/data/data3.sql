...
values
(nextval('requests_id_seq'), '2018-04-02 20:09:03.626463', 'DRAFT', 'NR00000023', null, null, 'CR', 'Y', null, null,
'dog walker', 1, 'N',null, null, null, current_timestamp, null)
;

insert into names
(id,name,state,choice,consumption_date,remote_name_id,nr_id)
values( nextval('names_id_seq'), 'my good company', 'NE', 1, null, null, (select id from requests where nr_num='NR00000023'))
;
insert into names
(id,name,state,choice,consumption_date,remote_name_id,nr_id)
