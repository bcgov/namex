...
[
    ...
    True),               # expected
    ('valid_temp_nr',
    None, 'NR L000001', 'info@example.com', '1231231234',
    None, 'NR L000001', 'info@example.com', '1231231234',
    True),
    ('no_nr',
    'NR 0000001', 'NR L000001', 'info@example.com', '1231231234',
    None, None, 'info@example.com', '1231231234',
    False),
    ('valid_nr_skip_nrl',
    'NR 0000001', 'NR L000001', 'info@example.com', '1231231234',
    'NR 0000001', 'NR L000001', 'info@example.com', '1231231234',
    ...
    ('valid_nr_only_email',
    'NR 0000001', 'NR L000001', 'info@example.com', '1231231234',
    'NR 0000001', 'NR L000001', 'info@example.com', None,
    True),
    ('valid_nr_only_phone',
    'NR 0000001', 'NR L000001', 'info@example.com', '1231231234',
    'NR 0000001', 'NR L000001', None, '1231231234',
    True),
    ('valid_nr_no_phone_no_email',
    'NR 0000001', 'NR L000001', 'info@example.com', '1231231234',
    'NR 0000001', 'NR L000001', None, None,
    False),
])
def test_full_access_to_name_request(test_name, \
    ...
    builder = EnvironBuilder(method='POST',
                             data={},
                             headers={'BCREG_NR': header_name_request_number,
