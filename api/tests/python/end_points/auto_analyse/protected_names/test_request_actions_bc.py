...
def test_designation_existence_request_response(client, jwt, app):
    ...
    test_params = [
        {'name': 'ARMSTRONG PLUMBING LTD.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'CHG'},
        {'name': 'ARMSTRONG PLUMBING LTD.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'DBA'},
        {'name': 'ARMSTRONG PLUMBING LTD.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'NEW'},
    ]
