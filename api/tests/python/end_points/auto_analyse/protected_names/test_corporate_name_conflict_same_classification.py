...
from ..common import assert_issues_count_is_gt, assert_issue_type_is_one_of, assert_has_word_upper, \
    save_words_list_classification, save_words_list_name, assert_correct_conflict, assert_additional_conflict_parameters
...
def test_corporate_name_conflict_same_classification_request_response(client, jwt, app, name, expected):
    ...
    conflict_list_db = ['BABY DOG CAFE LTD.', 'BABY DOG CAFE RESTAURANT LTD.',
                        'VALLEY VIEW REALTY LTD.', 'VALLEY DOUGLAS REALTY LTD.']
