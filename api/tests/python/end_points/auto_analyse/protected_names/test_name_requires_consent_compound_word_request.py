...
def test_name_requires_consent_compound_word_request_response(client, jwt, app):
    words_list_classification = [
        {'word': 'CANADIAN', 'classification': 'DIST'},
    ...
    words_list_virtual_word_condition = [
        {'words': 'SUMMER GAMES, WINTER GAMES', 'consent_required': True, 'allow_use': True},
        {
    ...
    test_params = [
        ...
        {'name': 'SAANICH FIRE PROTECTION LTD.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'NEW'},
    ]
