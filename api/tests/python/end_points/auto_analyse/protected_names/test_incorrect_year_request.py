...
def test_incorrect_year_request_response(client, jwt, app):
    ...
    test_params = [
        {'name': '2020 ARMSTRONG PLUMBING INC.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'NEW'},
        {'name': '1998 ARMSTRONG PLUMBING INC.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'NEW'},
        {
