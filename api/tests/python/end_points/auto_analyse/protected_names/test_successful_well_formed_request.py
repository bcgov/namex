...
def test_successful_well_formed_request_response(client, jwt, app):
    ...
    test_params = [
        {'name': 'ADEA HEATING INC.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'NEW'},
        {'name': 'ABC PLUMBING INC.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'NEW'},
    ]
