...
def test_add_descriptive_word_both_classifications_request_response(client, jwt, app):
    words_list_classification = [
        {'word': 'ABBOTSFORD', 'classification': 'DIST'},
    ...
    test_params = [
        {'name': 'ABBOTSFORD INC.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'NEW'},
        {'name': 'ROCKY MOUNTAIN INC.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'NEW'},
        # Name not allowed
        # {
