...
def test_corporate_name_conflict_compound_descriptive_response(client, jwt, app, name, expected):
    words_list_classification = [
        {'word': 'WESTWOOD', 'classification': 'DIST'},
    ...
    conflict_list_db = [
        'WESTWOOD FABRICARE LAUNDRY LTD.',
        'WESTWOOD FABRICS & WAREHOUSE LTD.',
        'VANCOUVER ISLAND CAR WASH LTD.',
        'VANCOUVER ISLAND CAR SERVICES LTD.',
        'WESTWOOD EARLY CHILDHOOD DEVELOPMENT LTD.',
        'WESTWOOD KIDS DEVELOPMENT LTD.',
        'WESTWOOD LIQUIFIED NATURAL GAS LTD.',
        'WESTWOOD NATURAL GAS PRODUCTS LTD.',
        "GARY'S LAUNDRY INC.",
        "GARY'S CLEAN SOLUTION INC.",
    ]
