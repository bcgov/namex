...
def test_add_descriptive_word_base_request_response(client, jwt, app):
    words_list_classification = [
        {'word': 'COSTAS', 'classification': 'DIST'},
    ...
    test_params = [
        {'name': 'COSTAS INC.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'NEW'},
        {'name': 'ABC INC.', 'location': 'BC', 'entity_type_cd': 'CR', 'request_action_cd': 'NEW'},
    ]
