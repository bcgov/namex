def data_for_add_distinctive_word_request_test():
    return {'name': 'FOOD GROWERS INC.', 'location': 'BC', 'entity_type_cd': 'UL', 'request_action_cd': 'NEW'}


def data_for_add_descriptive_word_request_test():
    return {'name': 'MOUNTAIN VIEW INC.', 'location': 'BC', 'entity_type_cd': 'UL', 'request_action_cd': 'NEW'}
