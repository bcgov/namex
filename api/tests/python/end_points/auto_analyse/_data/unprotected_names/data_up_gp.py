def data_for_contains_unclassifiable_word_request_test():
    return {'name': 'MOUNTAIN VIEW FOOD BLOGGINS', 'location': 'BC', 'entity_type_cd': 'GP', 'request_action_cd': 'NEW'}


def data_for_too_many_words_request_test():
    return {'name': 'MOUNTAIN VIEW FOOD GROWERS', 'location': 'BC', 'entity_type_cd': 'GP', 'request_action_cd': 'NEW'}
