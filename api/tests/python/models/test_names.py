...
def test_name_create(session):
    ...
    name = Name(name= "my good company", state= "NE", conflict1= None, conflict3= None, consumptionDate= None,
                corpNum= None, conflict2= None, designation= None, conflict1_num= None, decision_text= None,
                conflict3_num= None, conflict2_num= None, choice= 1)
...
def test_name_schema():
    ...
    name = Name(name= "my good company", state= "NE", conflict1= "conflict1", conflict2= "conflict2",
                conflict3= "conflict3", consumptionDate= None, corpNum= None,  designation= "LLC",
                conflict1_num= "NR 0000001", decision_text= "my descision", conflict3_num= "NR 0000003",
                conflict2_num= "NR 0000002", choice= 1)
...
def test_name_update_via_save_to_db_method(session):
    ...
    # setup
    test_name = "my good company"
    name_json = {"name": test_name, "state": "NE", "conflict1": "conflict1", "conflict2": "conflict2", "conflict3": "",
                 "consumptionDate": None, "corpNum": "S1234567",  "designation": "LLC", "conflict1_num": "NR 0000001",
                 "decision_text": "my descision", "conflict3_num": "", "conflict2_num": "A123456", "choice": 1}
    name_schema = NameSchema()
