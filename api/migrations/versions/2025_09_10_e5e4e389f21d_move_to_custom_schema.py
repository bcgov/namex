...
Revision ID: e5e4e389f21d
Revises: 179a7b0089ce
Create Date: 2025-09-10 13:47:17.696445
...
revision = 'e5e4e389f21d'
down_revision = '179a7b0089ce'
branch_labels = None
depends_on = None

logger = current_app.logger if hasattr(current_app, 'logger') else logging.getLogger("namex_api")
