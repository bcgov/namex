...
class _Config():  # pylint: disable=too-few-public-methods
    ...
    # fdw-registry
    DB1_USER = os.getenv('FDW_REGISTRIES_DATABASE_USERNAME', '')
    DB1_PASSWORD = os.getenv('FDW_REGISTRIES_DATABASE_PASSWORD', '')
    DB1_NAME = os.getenv('FDW_REGISTRIES_DATABASE_NAME', '')
    DB1_HOST = os.getenv('FDW_REGISTRIES_DATABASE_HOST', '')
    DB1_PORT = os.getenv('FDW_REGISTRIES_DATABASE_PORT', '5432')

    # fdw-names
    DB2_USER = os.getenv('FDW_NAMES_DATABASE_USERNAME', '')
    DB2_PASSWORD = os.getenv('FDW_NAMES_DATABASE_PASSWORD', '')
    DB2_NAME = os.getenv('FDW_NAMES_DATABASE_NAME', '')
    DB2_HOST = os.getenv('FDW_NAMES_DATABASE_HOST', '')
    DB2_PORT = os.getenv('FDW_NAMES_DATABASE_PORT', '5432')

    SQLALCHEMY_DATABASE_URI = f'postgresql://{DB1_USER}:{DB1_PASSWORD}@{DB1_HOST}:{DB1_PORT}/{DB1_NAME}'
    SQLALCHEMY_BINDS = {
        'db1': SQLALCHEMY_DATABASE_URI,
        'db2': f'postgresql://{DB2_USER}:{DB2_PASSWORD}@{DB2_HOST}:{DB2_PORT}/{DB2_NAME}'
    }
...
class TestConfig(_Config):
    """Creates the Testing Config object."""
