...
#Region "Constructors"
    ...
    Public Sub New()
        ...
        Me.Title = String.Format("VintaSoft WPF TWAIN File Transfer Demo v{0}", TwainGlobalSettings.ProductVersion)
...
#Region "Methods"
    ...
    Private Sub Window_Loaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
        ...
        Dim directoryForImages As String = System.IO.Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)
    ...
    ''' </summary>
    Private Sub SetWindowUiState(ByVal enabled As Boolean)
