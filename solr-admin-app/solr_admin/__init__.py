...
def create_application(run_mode=os.getenv('FLASK_ENV', 'production')):
    ...
    admin.add_view(restricted_link_word_condition_view.RestrictedLinkWordConditionView(restricted_link_word_condition.RestrictedWordConditon, models.db.session))
