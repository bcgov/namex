...
AS
    SELECT c.corp_num, c.recognition_dts, ct.corp_class
      FROM corporation@colin_readonly.bcgov c LEFT OUTER JOIN corp_name@colin_readonly.bcgov corp
           ON corp.corp_num = c.corp_num
           LEFT OUTER JOIN corp_type@colin_readonly.bcgov ct ON ct.corp_typ_cd = c.corp_typ_cd
